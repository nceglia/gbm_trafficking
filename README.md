...
The explorers (`gbm_temporal_explorer.html`, `gbm_signaling_explorer.html`, and
`gbm_report/`) are generated by `pipeline/explorer_*.py` scripts after the
corresponding analysis steps finish, and can be synced to a small VM.
