# %%
"""Single-file HTML explorer for L-R signaling.

Mirrors the gbm_temporal_explorer pattern: gzip+base64 CSVs inlined,
Plotly + pako + papaparse from CDN, no server. Output:
REPO_ROOT/gbm_signaling_explorer.html.
"""
import base64
import gzip
import io
...
LIANA_PATH = (REPO_ROOT / "results" / "12_liana_signaling"
              / "liana_per_timepoint.csv")
PATHWAY_CORRS_PATH = (REPO_ROOT / "results" / "11_cross_lineage_correlations"
                       / "pathway_correlations.csv")
DATA_OUT_DIR = REPO_ROOT / "results" / "signaling_explorer"
DATA_OUT_DIR.mkdir(parents=True, exist_ok=True)
OUTPUT_HTML = REPO_ROOT / "gbm_signaling_explorer.html"
