"""Build a self-contained gbm_temporal_explorer.html.

Embeds the per-(patient, tissue, timepoint, phenotype) tables produced by
10_temporal_scores.py and 10b_temporal_scores_myeloid.py as gzip+base64
inline payloads, and lays down a Plotly + Papaparse + pako single-file
explorer with selectable phenotypes/pathways/genes across 9 small
multiples (3 features x 3 tissues).
"""
import base64
import gzip
...
OUTPUT_PATH = REPO_ROOT / "gbm_temporal_explorer.html"
